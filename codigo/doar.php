...
<head>
    ...
    <link rel="stylesheet" href="../estilo/doar.css">
    <title>Favai</title>
</head>
...
<body>
    ...
    <div class="card-inicio">
        ...
        <div class="card-overlay">
          ...
          <p>Este site é uma parceria entre FAVAI-TECH e JCMD.</p>
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <h3>Sobre nós</h3>
          <p>Algumas informações sobre a nossa empresa e o que fazemos.</p>
        </div>
        <div class="col-lg-4">
          <h3>Contato</h3>
          <ul>
