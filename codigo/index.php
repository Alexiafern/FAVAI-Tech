            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12 col-xs-12">
                        <p class="oque-text">
                            A FAVAI-Tech representa cerca de 5 milhões de empresas que, juntas,
                            constituem cerca de 23,4% do PIB nacional e geram mais de 22 milhões de empregos diretos e formais. Veja abaixo como a FAVAI-Tech
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8 col-sm-8 col-xs-8 box-valorizo">
                            <img src="../img/natureza,jpg.webp" class="img-responsive center-block img-valorizo" alt="">
                            <p>Compartilhe sua história com o FAVAI-Tech e diga por que você valoriza as instituições.
